...
describe('device', () => {
  ...
  it('isMobileScreen', () => {
    const { isMobileScreen } = require('../device');
  ...
  describe('isAndroidChromeWithBrokenH264', () => {
    it('true on android chrome 125.0.0.0', () => {
      const { isAndroidChromeWithBrokenH264 } = require('../device');
...
describe('orientation', () => {
  const { isPortrait, getLandscapeMediaQuery } = require('../device');
...
describe('isDeviceUserFacing', () => {
  ...
  it('returns true when the device is user-facing', async () => {
    const { isDeviceUserFacing } = require('../device');
    const mockDevices = [
  ...
  it('returns false when the device is not user-facing', async () => {
    const { isDeviceUserFacing } = require('../device');
    const mockDevices = [
